...
/accelerate, /adapt-workflow, /amplify, /calibrate, /chain, /compose, /diagnose, /enrich, /evaluate, /extract-pattern, /fortify, /guard, /iterate, /onboard-agent, /refine, /specialize, /streamline, /teach-maestro, /temper, /turbocharge, /zero-defect
