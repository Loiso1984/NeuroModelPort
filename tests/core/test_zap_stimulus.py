...
def test_zap_stimulus_is_zero_outside_pulse_window():
    ...
    assert get_stim_current(50.0, stype_zap, iext, t0, td, tau, 1.0, 20.0, 5.0, _EW, _EW, 0) == 0.0
    assert get_stim_current(510.0, stype_zap, iext, t0, td, tau, 1.0, 20.0, 5.0, _EW, _EW, 0) == 0.0
...
def test_zap_stimulus_frequency_increases_over_time():
    ...
    x = np.array([get_stim_current(tt, stype_zap, iext, t0, td, tau, f0, f1, 5.0, _EW, _EW, 0) for tt in t])
