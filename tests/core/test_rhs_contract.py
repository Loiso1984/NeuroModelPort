...
def test_rhs_arg_index_map_is_contiguous_and_stable_keys_present():
    ...
    assert RHS_ARG_INDEX["stype"] < RHS_ARG_INDEX["stype_2"]
...
def test_pack_rhs_args_rejects_missing_or_extra_keys():
    ...
    assert packed[-1] == baseline["rng_state"]
...
def test_validate_rhs_args_values_rejects_shape_mismatch():
    ...
    values["mg_ext"] = 1.0
    values["tau_sk"] = 5.0
    # Primary stimulus fields
    values["stype"] = 0
    values["iext"] = 0.0
    values["t0"] = 0.0
    values["td"] = 0.0
    values["atau"] = 2.0
    values["zap_f0_hz"] = 0.0
    values["zap_f1_hz"] = 0.0
    values["stim_comp"] = 0
    values["stim_mode"] = 0
    values["use_dfilter_primary"] = 0
    values["dfilter_attenuation"] = 1.0
    values["dfilter_tau_ms"] = 0.0
    # Secondary stimulus fields
    ...
    values["td_2"] = 0.0
    values["atau_2"] = 2.0
    values["zap_f0_hz_2"] = 0.0
    values["zap_f1_hz_2"] = 0.0
    values["stim_comp_2"] = 0
    values["stim_mode_2"] = 0
    values["use_dfilter_secondary"] = 0
    values["dfilter_attenuation_2"] = 1.0
    ...
    bad8 = dict(values)
    bad8["dual_stim_enabled"] = 1
    bad8["use_dfilter_secondary"] = 2
    try:
